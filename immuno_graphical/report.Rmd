...
if (if.pair==1 | study_name=="VAT08m"){
...
demos <- c("age_group","risk_group","age_risk_group","sex_group","age_sex_group","ethnicity","race","minority_group","age_minority_group",if(study_name=="ENSEMBLE")"country", if(study_name=="ENSEMBLE")"hiv_group")

demoLabels <- c("age groups","high-risk condition","age and high-risk condition","sex assigned at birth","age and sex assgined at birth","ethnicity","race","dichotomous classification of
...
demos <- c("age_group","risk_group","age_x_risk_group","sex","age_x_sex_group","ethnicity","race","minority_group","age_x_minority",if(study_name=="ENSEMBLE")"country", if(study_name=="ENSEMBLE")"hiv_group")
