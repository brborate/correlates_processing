...
caption <- "Cases per treatment arm after applying RiskscorecohortFLAG (prior to risk score analysis). 18 subjects with missing value for endpoint were dropped from analysis."
new_colnames = c("Non-Cases", paste0("Post-", day, "-Cases"))
