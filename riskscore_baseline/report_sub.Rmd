...
if(endpoint %in% c("EventIndPrimaryD29", "EventIndPrimaryIncludeNotMolecConfirmedD29"))
  day = "Day 29"
if(endpoint %in% c("EventIndPrimaryD35"))
  day = "Day 35"

caption <- "Individual baseline variables in baseline SARS-CoV-2 negative per-protocol placebo recipients that were input into the Superlearner model for developing risk score and predicting occurrence of COVID-19 in ."
...
read.csv(here("riskscore_baseline", "output", Sys.getenv("TRIAL"), "cases_prior_to_applying_Riskscorecohortflag.csv"), row.names = 1,
  ...
  kable_styling(latex_options = c("hold_position"),
                font_size = 9) %>%
  footnote(c(paste0("Post-Day ", day, " Cases: COVID-19 primary endpoints that occur at least 7 days after the ", day, " visit.")),
             threeparttable = TRUE)
